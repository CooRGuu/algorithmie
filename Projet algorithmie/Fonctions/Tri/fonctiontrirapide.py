...
# Fonction principale pour trier les produits par quantité en utilisant Pandas (anciennement tri rapide)
def fonctiontrirapide(nom_fichier, proprietaire):
    ...
    try:
        ...
        # Appliquer le tri en utilisant la méthode Pandas `sort_values()`
